...
class PersonalOutLog(Document):
	...
	def update_monthly_in_out_log(self):
		"""
		Recalculate Monthly In-Out Log when Personal Out Log changes
		"""
		try:
			...
			frappe.log_error(message=f"Error updating Monthly In-Out Log: {e}", title="Monthly In-Out Log Update Error - Personal Out Log")
